...
```bash
python offline/train.py --model <name> --annotation-run-id <id> ...
python offline/infer.py --model <name> --test-json data/Test/queries/queries.json ...
...
以代码（`aicomp_grounding/models/`）为准。
