...
class Qwen3VLAdapter:
    ...
    def build_training_batch(
        ...
        *,
        ...
        prompt_messages = build_grounding_messages(visible, item["query"], system_prompt=QWEN3VL_SYSTEM_PROMPT, user_template=QWEN3VL_USER_TEMPLATE)
        messages = build_training_messages(visible, item["query"], bbox_text, system_prompt=QWEN3VL_SYSTEM_PROMPT, user_template=QWEN3VL_USER_TEMPLATE)
    ...
    def build_grounding_batch(self, samples: list[ModelInput], *, processor) -> dict:
        ...
        messages = [
            build_grounding_messages(sample.visible, sample.query, system_prompt=QWEN3VL_SYSTEM_PROMPT, user_template=QWEN3VL_USER_TEMPLATE)
